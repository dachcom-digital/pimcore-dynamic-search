    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('element_listener_options')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('allowed_document_types')->defaultValue(['page'])
                            ->cannotBeEmpty()
                            ->scalarPrototype()
                                ->validate()
                                    ->ifNotInArray(['page', 'hardlink', 'link', 'email', 'snippet'])
                                    ->thenInvalid('Invalid document type %s')
                                ->end()
                            ->end()
                        ->end()
                    ->end()
