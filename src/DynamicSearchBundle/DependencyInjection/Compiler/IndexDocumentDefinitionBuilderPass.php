...
final class IndexDocumentDefinitionBuilderPass implements CompilerPassInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        foreach ($container->findTaggedServiceIds('dynamic_search.index_document_definition_builder', true) as $id => $tags) {
